...
public class YoilTellerMVC5 {
    ...
    @RequestMapping("/getYoilMVC5") // http://localhost:8080/ch2/getYoilMVC5?year=2022&month=11&day=1
...
//  public String main(@ModelAttribute("myDate") MyDate date) { // 아래와 동일
    public String main(@ModelAttribute MyDate date) { // @ModelAttribute사용, 반환 타입은 String
...
//      m.addAttribute("myDate", date); // 2022 11 1
//      m.addAttribute("yoil", yoil);   // 화
