...
public class MethodCall2 {
    public static void main(String[] args) throws Exception{
        ...
        // 3. Model을 생성
        Model model = new BindingAwareModelMap();   // 구현체를 통해서
        System.out.println("[before] model="+model);

        // 4. main메서드를 호출
        // 객체 배열을 동적으로 처리!!
//         String viewName = obj.main(2022, 10, 30, model);
        // 위 코드를 Reflection API를 이용한 호출
        String viewName = (String)main.invoke(obj, new Object[] { 2022, 10, 30, model });
